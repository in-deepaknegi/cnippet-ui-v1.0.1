        ...
        <>
            ...
            <main>
                <div className="max-w-3xl mx-auto mt-20">
                    ...
                    <p className="mb-4">
                        <strong>Cnippet</strong> understands that plans may change. If you need to modify your booking, please contact us at [<a href="mailto:office@cnippet.com" className='text-blue-700'>office@cnippet.com</a> ] as soon as possible, and we will do our best to accommodate your request.
                    </p>
                    ...
                    <p className="mb-4">
                        For any cancellation or modification requests, please contact us at [<a href="mailto:office@cnippet.com" className='text-blue-700'>office@cnippet.com</a> ].
                    </p>
