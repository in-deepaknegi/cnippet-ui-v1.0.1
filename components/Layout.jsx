...
const Layout = ({ components }) => {
    ...
    return (
        <section className="relative isolate overflow-hidden rounded-2xl mt-10">
            <Image
                src={Hero1}
                alt="hero-image"
                priority={true}
            ...
            <h2 className="text-white px-8 pt-10">
            ...
            <div className="h-full w-full py-12">
                <div className="relative flex flex-1 flex-col items-center justify-center">
                    <div className="w-full max-w-sm">
                        <button
                            onClick={handleLogin}
                            className="inline-flex w-full justify-center rounded-lg border border-olive-300 px-4 py-2.5 text-base hover:bg-black hover:border-olive-700 text-white">
                            {loading && (
