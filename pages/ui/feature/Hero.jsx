                                            ...
                                            <div className='mx-auto grid gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none grid-cols-12'>
                                                <div className='col-span-12 lg:pr-8 lg:pt-4 lg:col-span-7'>
                                                    <div className=''>
                                                        ...
                                                        <div className='mt-10 grid grid-cols-2 gap-x-4 max-w-xl text-base leading-7 text-gray-600 lg:max-w-none'>
                                                            {features.slice(0, 2).map((feature) => (
                                                                <div key={feature.name}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="6" height="16" x="4" y="2" rx="2"/><rect width="6" height="9" x="14" y="9" rx="2"/><path d="M22 22H2"/></svg>
                                                                    <h2 className='my-2 text-2x font-semibold text-gray-900'>{feature.name}</h2>
                                                                    <p>
                                                                        {feature.description}
                                                                    </p>
                                                                </div>
                                                ...
                                                <div className='col-span-12 lg:col-span-5'>
                                                    <Image
                                                        ...
                                                        quality={100}
                                                        loading='eager'
                                                        className='h-[20rem] lg:h-[33rem] object-cover rounded-2xl'
                                                    />
                                                </div>
                                            </div>
                                        </div>
