...
const List = () => {
    return (
        <section className='mx-auto w-full px-4 sm:px-6 lg:px-8'>
            ...
            <p className="mt-3 text-sm leading-7 text-slate-500">Form layouts, tables, modal dialogs — everything you need to build beautiful responsive web applications.</p>
