        ...
        <section className="bg-white">
            <div className="relative isolate px-6 pt-14 lg:px-8 h-screen">
                ...
                <div className="mx-auto max-w-2xl py-40">
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <a href="#" className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Browse Components</a>
                ...
                <div className="absolute inset-x-0 top-[calc(100%-20rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[40vh]" aria-hidden="true">
                    <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] rotate-[20deg] bg-gradient-to-br from-blue-700 to-fuchsia-400 opacity-30 sm:left-[-10rem] sm:w-[50.1875rem]" ></div>
                </div>
            </div>
        </section>
    )
