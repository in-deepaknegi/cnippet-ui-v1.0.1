...
const features = [
    {
        ...
        href: "#",
        svg: (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='w-6 h-6 text-blue-600'><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>)
    },
    {
        id: 2,
...
const List2 = () => {
    return (
        <section className="bg-white py-24 sm:py-28">
            <div className="mx-auto grid max-w-7xl px-6 lg:grid-cols-2 lg:px-8">
                ...
                <div className="mx-auto mt-16 max-w-2xl lg:mt-0 lg:max-w-none lg:px-10">
                    <dl className="flex flex-col space-y-10">
                        {features.map((feature) => (
                            <div key={feature.id} className="h-full w-full">
