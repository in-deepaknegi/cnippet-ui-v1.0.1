        ...
        <section className="px-6 py-6 lg:px-8 lg:py-20">
            ...
            >
                ...
                <div className="relative isolate overflow-hidden py-12 sm:px-24">
                    <h2 className="mx-auto max-w-2xl text-center text-3xl font-bold tracking-wide text-olive-100 sm:text-4xl" >
                        Get the Latest Hiking Updates
                    </h2>
                    <p
                        className="mx-auto mt-4 max-w-2xl text-center text-sm text-olive-200 sm:text-base">
