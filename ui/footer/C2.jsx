            ...
            <div className="mx-auto px-6 lg:px-8">
                <div className="mb-6 sm:flex sm:justify-between">
                    ...
                    <div className="mt-10 flex max-w-md gap-x-28 md:mr-32 md:mt-5 md:max-w-none md:justify-between">
                        <div>
                            <h3 className="mb-3 text-sm font-bold text-gray-900">Support</h3>
                ...
                <div className="flex flex-col justify-between space-y-4 border-t border-gray-200 pt-8 md:flex-row md:space-y-0">
