        ...
        <main className='pt-8 pb-16 antialiased lg:pt-16 lg:pb-24'>
            <div className='mx-auto flex max-w-6xl justify-between px-4 lg:px-0'>
                <article className="relative max-w-2xl mx-auto pt-10">
                    ...
                    <div className="mt-12 flex flex-col gap-y-6 text-gray-800 font-sans">
                        <p className='text-lg'>
                        ...
                        <div className='mb-6 rounded-2xl border p-6 shadow-xl'>
                            <a href="#" className='mb-4 flex gap-4 items-center'>
                                <Image
                                    ...
                                    className="h-8 w-8 rounded-full bg-gray-50 object-cover" />
                                <div className="text-sm leading-4">
                                    <div className="text-slate-900 font-semibold">Adam Wathan</div>
                                </div>
                            </a>
                            <p className='mb-4 text-sm text-slate-900'>
                                Hey! I&apos;m Adam Wathan. I&apos;m a career-changer. Bootcamp grad & Dev.
                            </p>
